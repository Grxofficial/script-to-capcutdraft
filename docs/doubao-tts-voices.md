...
来源：官方文档《音色列表》（2026-09-07 快照）。用法：`script-to-capcutdraft compose --voice <voice_type>`。
中文音色亦具备英文能力，但英文场景官方更推荐外语音色（另 151 个，见官方文档）。

| 场景 | 音色名称 | voice_type | 语种/方言 | 支持能力 |
|---|---|---|---|---|
| 通用场景 | Vivi 2.0 | zh_female_vv_uranus_bigtts | 语种：中文、日文、印尼、墨西哥西班牙语 方言：粤语、上海、河南、北京、天津、四川、陕西、东北 | 指令遵循 |
| 通用场景 | 小何 2.0 | zh_female_xiaohe_uranus_bigtts | 语种：中文 方言：粤语、上海、河南、北京、天津、四川、陕西、东北 | 指令遵循 |
| 通用场景 | 云舟 2.0 | zh_male_m191_uranus_bigtts | 语种：中文 方言：粤语、上海、河南、北京、天津、四川、陕西、东北 | 指令遵循 |
| 通用场景 | 小天 2.0 | zh_male_taocheng_uranus_bigtts | 语种：中文 方言：粤语、上海、河南、北京、天津、四川、陕西、东北 | 指令遵循 |
...
| 视频配音 | 佩奇猪 2.0 | zh_female_peiqi_uranus_bigtts | 中文 | 指令遵循 |
...
| 外语音色 | Tim | en_male_tim_uranus_bigtts | 美式英语 | 指令遵循 |
| 外语音色 | Dacey | en_female_dacey_uranus_bigtts | 美式英语 | 指令遵循 |
| 外语音色 | Stokie | en_female_stokie_uranus_bigtts | 美式英语 | 指令遵循 |
...
| 角色扮演 | 直率英子 2.0 | zh_female_zhishuaiyingzi_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 邻家男孩 2.0 | zh_male_linjiananhai_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 四郎 2.0 | zh_male_silang_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 儒雅青年 2.0 | zh_male_ruyaqingnian_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 擎苍 2.0 | zh_male_qingcang_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 熊二 2.0 | zh_male_xionger_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 樱桃丸子 2.0 | zh_female_yingtaowanzi_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 温暖阿虎 2.0 | zh_male_wennuanahu_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 奶气萌娃 2.0 | zh_male_naiqimengwa_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 婆婆 2.0 | zh_female_popo_uranus_bigtts | 中文 | 指令遵循 |
...
| 通用场景 | 温柔淑女 2.0 | zh_female_wenroushunv_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 古风少御 2.0 | zh_female_gufengshaoyu_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 活力小哥 2.0 | zh_male_huolixiaoge_uranus_bigtts | 中文 | 指令遵循 |
| 有声阅读 | 霸气青叔 2.0 | zh_male_baqiqingshu_uranus_bigtts | 中文 | 指令遵循 |
| 有声阅读 | 悬疑解说 2.0 | zh_male_xuanyijieshuo_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 萌丫头 2.0 | zh_female_mengyatou_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 贴心女声 2.0 | zh_female_tiexinnvsheng_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 鸡汤妹妹 2.0 | zh_female_jitangmei_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 磁性解说男声 2.0 | zh_male_cixingjieshuonan_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 亮嗓萌仔 2.0 | zh_male_liangsangmengzai_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 开朗姐姐 2.0 | zh_female_kailangjiejie_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 高冷沉稳 2.0 | zh_male_gaolengchenwen_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 深夜播客 2.0 | zh_male_shenyeboke_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 鲁班七号 2.0 | zh_male_lubanqihao_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 娇喘女声 2.0 | zh_female_jiaochuannv_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 林潇 2.0 | zh_female_linxiao_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 玲玲姐姐 2.0 | zh_female_lingling_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 春日部姐姐 2.0 | zh_female_chunribu_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 唐僧 2.0 | zh_male_tangseng_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 庄周 2.0 | zh_male_zhuangzhou_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 开朗弟弟 2.0 | zh_male_kailangdidi_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 猪八戒 2.0 | zh_male_zhubajie_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 感冒电音姐姐 2.0 | zh_female_ganmaodianyin_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 谄媚女声 2.0 | zh_female_chanmeinv_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 女雷神 2.0 | zh_female_nvleishen_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 亲切女声 2.0 | zh_female_qinqienv_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 快乐小东 2.0 | zh_male_kuailexiaodong_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 开朗学长 2.0 | zh_male_kailangxuezhang_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 悠悠君子 2.0 | zh_male_youyoujunzi_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 文静毛毛 2.0 | zh_female_wenjingmaomao_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 知性女声 2.0 | zh_female_zhixingnv_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 清爽男大 2.0 | zh_male_qingshuangnanda_uranus_bigtts | 中文 | 指令遵循 |
...
| 角色扮演 | 武则天 2.0 | zh_female_wuzetian_uranus_bigtts | 中文 | 指令遵循 |
| 角色扮演 | 顾姐 2.0 | zh_female_gujie_uranus_bigtts | 中文 | 指令遵循 |
| 通用场景 | 广告解说 2.0 | zh_male_guanggaojieshuo_uranus_bigtts | 中文 | 指令遵循 |
...
| 外语音色 | Frosty Man 2.0 | ICL_uranus_en_male_frosty_man_tob | 美式英语 |  |
| 外语音色 | The Grinch 2.0 | ICL_uranus_en_male_the_grinch_tob | 美式英语 |  |
| 外语音色 | Kevin McCallister 2.0 | ICL_uranus_en_male_kevin_mccallister_tob | 美式英语 |  |
| 外语音色 | Michael 2.0 | ICL_uranus_en_male_michael_tob | 美式英语 |  |
| 外语音色 | Big Boogie 2.0 | ICL_uranus_en_male_big_boogie_tob | 美式英语 |  |
